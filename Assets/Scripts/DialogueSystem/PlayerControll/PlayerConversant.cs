...
namespace RPG.DialogueSystem
{
    ...
    {
        public DialogueCharacterInfo DialoguePlayerInfo => dialoguePlayerInfo;  // 外部获取
        ...
        public DialogueNode CurrentDialogueNode => currentDialogueNode;     // 外部获取
        public Action onDialogueChange;                         // 对话物体改变时
        public Action onDialogueNodeChange;                     // 对话节点改变时
        [SerializeField] private DialogueCharacterInfo dialoguePlayerInfo;  // 玩家信息
        private Dialogue currentDialogue;                       // 当前对话物体
        private DialogueNode currentDialogueNode;               // 当前节点
        ...
        {
            currentDialogue = _currentNPC.Dialogue;
        ...
        {
            foreach (DialogueNode playerChild in ConditionFitter(currentDialogue.GetInteractiveChildren(currentDialogueNode)))
            {
        ...
        private IEnumerable<DialogueNode> ConditionFitter(IEnumerable<DialogueNode> dialogueNodes)
        {
            // TODO: 改善遍历逻辑
            // 筛选符合Condition的节点
        ...
        public void Next()
        {
            ...
            if (!isPlayerChoice)
            {
                ...
                // 获取所有不可交互的对话节点
                DialogueNode[] nonInteractiveChildren = ConditionFitter(currentDialogue.GetNonInteractiveChildren(currentDialogueNode)).ToArray();
                // 推动节点变换 移动至下一节点
        ...
        public void Choose(DialogueNode chooseNode)
        {
            // 选择选项
